...
--
-- Database: pis_db
-- Generation Time: 2020-03-04 16:05:39.5180
-- -------------------------------------------------------------
...
DROP TABLE IF EXISTS `pis_bakery`;
...
DROP TABLE IF EXISTS `pis_daily_sale`;
...
DROP TABLE IF EXISTS `pis_delivery`;
...
DROP TABLE IF EXISTS `pis_delivery_detail`;
...
DROP TABLE IF EXISTS `pis_request`;
...
DROP TABLE IF EXISTS `pis_setting`;
...
DROP TABLE IF EXISTS `pis_store`;
